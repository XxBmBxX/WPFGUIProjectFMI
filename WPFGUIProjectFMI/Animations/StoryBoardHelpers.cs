...
namespace WPFGUIProjectFMI
{
    ...
    public static class StoryboardHelpers
    {
        ...
        #region Vertical animations
    public static void AddSlideToUp(this Storyboard storyboard, float seconds, double offset, float decelerationRatio = 0.6f, bool keepMargin = true)
        {
            var animation = new ThicknessAnimation
            {
                Duration = new Duration(TimeSpan.FromSeconds(seconds)),
        ...
        public static void AddSlideFromDown(this Storyboard storyboard, float seconds, double offset, float decelerationRatio = 0.6f, bool keepMargin = true)
        {
            // Create the margin animate from right 
            var animation = new ThicknessAnimation
            {
